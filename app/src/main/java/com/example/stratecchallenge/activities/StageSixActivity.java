...
public class StageSixActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calculate.setOnClickListener(v -> handleOptimalTransferMoving());

        back.setOnClickListener(v -> {
            Intent intent = new Intent(StageSixActivity.this, MainActivity.class);
            startActivity(intent);
        });
    }

    private void handleOptimalTransferMoving(){
        ...
        StringBuilder result = controller.calculateOptimalTransferMoving(planets, start, dest, rocket);
